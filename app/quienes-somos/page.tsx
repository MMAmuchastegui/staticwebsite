...
export const metadata: Metadata = {
  ...
  description:
    "Geding nace en 1999 como una empresa de ingeniería en energía eléctrica y sistemas de control.",
};
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-6 text-steel text-[15px] leading-relaxed normal-case">
            Geding nace en el año {site.foundedYear} como una empresa de
            ingeniería en energía eléctrica y sistemas de control. Hoy somos
            referentes en servicios de ingeniería especializada y servicios
            para la integración de Sistemas de Control, con importantes
            clientes y sistemas que lo avalan.
          </p>
          <p className="mt-4 text-steel text-[15px] leading-relaxed normal-case">
            En todo proyecto que nos confían, nuestros clientes tienen la
            seguridad de contar con la solución técnica y económica
            apropiada, acompañada de todos los cálculos, planos, documentos,
            manuales y capacitación que respaldan nuestros proyectos.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-5 py-16 grid md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-steel-light normal-case mb-3">
              En GEDING, calidad es sinónimo de satisfacción de clientes,
